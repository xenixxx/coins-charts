...
idf = pd.read_csv("/home/user/PycharmProjects/coins-charts/bitcoin_data_tut.csv")
...
mpf.plot(idf.tail(60), type='candle', style='mike', ylabel='BTC / USD', savefig=saveTmp)


idf = pd.read_csv("/home/user/PycharmProjects/coins-charts/bitcoin_data_tut.csv")
# idf = pd.read_csv("", index_col=100)
idf['minute'] = pd.to_datetime(idf['minute'], format="%m/%d/%Y %H:%M")
idf.set_index('minute', inplace=True)
